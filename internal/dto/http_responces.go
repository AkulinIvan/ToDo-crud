...
const (
	...
	StatusOKAnswer     = "The operation was completed successfully"
	NotFoundTaskError  = "Task not found"
)
...
func StatusOK(ctx *fiber.Ctx, desc any) error {
...
func NotFound(ctx *fiber.Ctx, code, desc string) error {
